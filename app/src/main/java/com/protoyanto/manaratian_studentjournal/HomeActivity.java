...
public class HomeActivity extends AppCompatActivity
    ...
    public void onCLickWebsite(View view) {
        ...
        Toast.makeText(getApplicationContext(), "Welcome to MANARAT INTERNATIONAL UNIVERSITY website.",
                Toast.LENGTH_SHORT)
                .show();

    }

    public void onlickPortal(View view) {
        Intent intent = new Intent(this, PortalActivity.class);
        portalBtn = findViewById(R.id.portalBtn);
        startActivity(intent);
        Toast.makeText(getApplicationContext(), "Welcome yo Manarat International University portal",
                Toast.LENGTH_SHORT)
                .show();
